<div>
    ...
    <form wire:submit.prevent="submit">
        ...
        @if ($cursusname)
        <div class="m-2">
            <label for="title" class="form-label">Cursus:</label>
            <input type="text" id="title" value="{{$cursusname->name}}" readonly class="form-control">
        </div>
        @endif
        ...
        <div class="m-2">
            <label for="cursus_id">Nouveau cursus:</label>
